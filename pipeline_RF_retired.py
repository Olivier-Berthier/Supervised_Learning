...
def RF_retired (X_train, y_train, X_val, y_val, categorical_columns, boolean_columns, numeric_columns):
    """
    ...
    param_grid = {
        ...
        'classifier__max_depth': [15],                  # Profondeur maximale des arbres
        'classifier__min_samples_split': [10],         # Nombre minimal d'échantillons pour diviser un nœud
        'classifier__min_samples_leaf': [5],           # Nombre minimal d'échantillons par feuille
        'classifier__max_features': [0.4],        # Fraction des features utilisées lors de la construction
    ...
    plot_confusion_matrices(grid_search_RF, X_train, y_train, X_val, y_val, model_name="RF_retired")