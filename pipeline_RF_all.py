...
def RF_all(X_train, y_train, X_val, y_val, categorical_columns, boolean_columns, numeric_columns):
    """
    ...
    plot_confusion_matrices(grid_search_RF, X_train, y_train, X_val, y_val, model_name="RF_all")
