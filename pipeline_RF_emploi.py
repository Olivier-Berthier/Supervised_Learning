...
def RF_emploi(X_train, y_train, X_val, y_val, categorical_columns, boolean_columns, numeric_columns):
    """
    ...
    'classifier__max_features': [0.5],                    # Fraction des features utilisées pour chaque arbre
    ...
    plot_confusion_matrices(grid_search_RF, X_train, y_train, X_val, y_val, model_name="RF_emploi")